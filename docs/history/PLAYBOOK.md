...
Reusable framework by Touko Ursin, recovered from the [Sunstead initial commit](https://github.com/toukkelipoukkeli-glitch/sunstead/tree/0e4744ba4c6b3b7393f9be8c57ff2a216aa3fdf0). The [Astra event rules](EVENT.md) override generic advice, including model defaults and dashboard examples. Use Astra in development and in the product.
