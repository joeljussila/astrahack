...
For Astra, the [event rules](EVENT.md) override generic preparation advice below. Build submission code during the event; pre-event preparation is for learning and planning.
...
- confirm the stack and tools; build the actual submission during the event
